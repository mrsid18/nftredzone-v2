                  ...
                  <div className="header-nav-inner">
                    ...
                    >
                      {this.props.homepage ? (
                        <>
                          ...
                          <li>
                            <Link to="schedule">Spotlight Schedule </Link>
                          </li>
                        </>
                      ) : (
                        <>
                      ...
                      {/* <li>
                        <SmoothScroll duration={700} to="frontOffice" onClick={this.closeMenu}>
                          Front Office
                        </SmoothScroll>
                      </li>
                      <li>
                        <SmoothScroll duration={700} to="faq" onClick={this.closeMenu}>
                          FAQ
                        </SmoothScroll>
                      </li> */}
                    </ul>
                    {!hideSignin && (
                      <ul className="list-reset header-nav-right">
                        <li>
                          <a
                            href="https://nft-redzone-1.gitbook.io/nft-redzone/"
                            target="_blank"
